...
public class ExceptionFilter : IExceptionFilter
{
    ...
    {
        var result = context.Exception is PassInException; //verifico se resultado é passinexception
        if (result)
        {
            HandleProjectException(context); //se for verdadeiro chama essa função
        }
        else
        {
